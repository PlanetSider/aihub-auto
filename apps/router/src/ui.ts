...
<div class="shell">
  ...
  <main class="workspace">
    ...
    <section class="panel wide">
      ...
      <div class="table-wrap"><table id="candTable"><thead><tr><th>排名</th><th>分组</th><th class="num">倍率</th><th class="num">TTFT</th><th class="num">保守延迟</th><th class="num">置信度</th><th class="num">3小时稳定</th><th class="num">得分</th><th>路由状态</th><th>黑名单</th></tr></thead><tbody></tbody></table></div>
    </section>
  </main>
</div>
...
const reasonName={platform_mismatch:"平台不匹配",unavailable_group:"账户不可用",invalid_rate:"倍率无效",price_band:"超出倍率区间",blacklisted:"已加入黑名单",invalid_latency:"延迟无效",local_error_rate:"近期稳定率过低",economy_price_tier:"备用价格层"};
